...
HD_PWD='C:/Users/andy.zhang/work/fpga_proj/syntacore/project_1/project_1.runs/system_jtag_axi_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_jtag_axi_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_jtag_axi_0_0.tcl
