...
HD_PWD='C:/Users/andy.zhang/work/fpga_proj/syntacore/project_1/project_1.runs/system_ahblite_axi_bridge_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_ahblite_axi_bridge_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_ahblite_axi_bridge_0_0.tcl
